...
def main():
    ...
    print "--temp=22"
    print "--power=on|off"
    print "--schedule='[[{\"start_hour\":6,\"temp\":23.0,\"start_minute\":0},...],[...]]'" # ./broadlink-thermostat-cli.py --schedule='[[{"start_hour":6,"temp":22.5,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0}],[{"start_hour":6,"temp":22.5,"start_minute":0},{"start_hour":23,"temp":15.0,"start_minute":0}]]'
        ...
        if device.auth():
            for arg in args:
                if arg[0] == "--mode":
                    ...
                    if len(schedules) != 2:
                        print "schedule should contain 2 array, weekday and weekend."
                    else:
                        device.set_schedule(schedules[0], schedules[1])
            print device.type
